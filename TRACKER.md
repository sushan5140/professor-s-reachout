...
| Professor | University | Area / Lab | Status | Proposal | Reply / Next Action |
|---|---|---|---|---|---|
| Myeonggyun Han | KNU | CoSAIL — AI systems / on-device RAG | REPLIED_POSITIVE | Proposal prepared | Professor requested a short proposal and clarified UG/GKS details. Reply/proposal workflow active. |
| Wonsuk Kim | PNU | Physical AI / Sim2Real | SENT | — | Awaiting reply |
| Sung Ju Hwang | KAIST | LLM agents / memory transfer | SENT | — | Awaiting reply |
| Eunho Yang | KAIST | LLM / database reasoning | REPLIED_NEGATIVE | — | No available positions |
| Se-Young Yun | KAIST | LLM evaluation / limited budgets | SENT | — | Awaiting reply |
| Sangdon Park | POSTECH | Tool-using LLM agents | SENT | Locked concept | Awaiting reply |
| Kwang-Sung Jun | POSTECH | Active preference learning | SENT | Locked concept | Awaiting reply |
| Youngsoo Jang | UNIST | Offline-to-online LLM agents | SENT | Locked concept | Awaiting reply |
...
| Donghyun Yu | Chonnam | Cryptography & Security Protocol Lab — verifiable FL / AI security | DRAFTED | — | Customized draft ready; current recruitment favors 3rd-year+ students, so mail does not claim eligibility |
